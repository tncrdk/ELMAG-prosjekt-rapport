...
\begin{table}[]
    ...
    \end{tabular}
    \caption{Tabellen viser gjennomsnittet, medianen og standardavviket for deklinasjonen over målingene. Igjen ble det ikke gjort noen målinger med flymodus for Oskar, derfor finnes det ikke noen måledata for 
\end{table}