...
Til slutt ble måledataene for Iphone 13 for Nidarosdomen filtrert ut, på grunn stort avvik fra de andre 
...
\begin{figure}
    ...
    \caption{Skisse av telefon under måling. Skissen viser også koordinatsystemet, angitt med $\hat{x, y, z}$ som benyttes til analyse.}
